<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:136:"F:\xampp-win32-5.6.3-0-VC11-installerroot\xammp\htdocs\www\www.public.devp\public/../application/backend\view\comment\feedback_list.html";i:1544773672;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<tbody>
				<tr class="text-c">
					...
					<td>1</td>
					<td><a href="javascript:;" onclick="member_show('张三','<?php echo url('member/member_show'); ?>','10001','360','400')"><i class="avatar size-L radius"><img alt="" src="/static/h-ui/images/ucnter/avatar-default-S.gif"></i></a></td>
					<td class="text-l"><div class="c-999 f-12">
							<u style="cursor:pointer" class="text-primary" onclick="member_show('张三','<?php echo url('member/member_show'); ?>','10001','360','400')">张三</u> <time title="2014年8月31日 下午3:20" datetime="2014-08-31T03:54:20">2014-8-31 15:20</time> <span class="ml-20">13000000000</span> <span class="ml-20">admin@mail.com</span></div>
						...
						<div>留言内容</div></td>
					<td class="td-manage"><a title="编辑" href="javascript:;" onclick="member_edit('编辑','<?php echo url('member/member_add'); ?>','4','','510')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="member_del(this,'1')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
				<tr class="text-c">
					<td><input type="checkbox" value="1" name=""></td>
					<td>1</td>
