<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:133:"F:\xampp-win32-5.6.3-0-VC11-installerroot\xammp\htdocs\www\www.public.devp\public/../application/backend\view\system\system_data.html";i:1544781529;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				<tr class="text-c">
					...
					<td>city</td>
					<td>city</td>
					<td class="f-14"><a style="text-decoration:none" onclick="system_data_edit('角色编辑','<?php echo url('system/system_data_edit'); ?>','0001','400','310')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
