<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:135:"F:\xampp-win32-5.6.3-0-VC11-installerroot\xammp\htdocs\www\www.public.devp\public/../application/backend\view\product\product_list.html";i:1544771475;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
			...
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				...
				<tbody>
					<tr class="text-c va-m">
						...
						<td>001</td>
						<td><a onClick="product_show('哥本哈根橡木地板','<?php echo url('product/product_show'); ?>','10001')" href="javascript:;"><img width="60" class="product-thumb" src="/temp/product/Thumb/6204.jpg"></a></td>
						<td class="text-l"><a style="text-decoration:none" onClick="product_show('哥本哈根橡木地板','<?php echo url('product/product_show'); ?>','10001')" href="javascript:;"><img title="国内品牌" src="/static/h-ui.admin/images/cn.gif"> <b class="text-success">圣象</b> 哥本哈根橡木地板KS8373</a></td>
