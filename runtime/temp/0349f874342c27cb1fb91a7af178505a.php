<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:126:"F:\xampp-win32-5.6.3-0-VC11-installerroot\xammp\htdocs\www\www.public.devp\public/../application/backend\view\index\index.html";i:1544782226;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
	...
	<aside class="Hui-aside">
		<div class="menu_dropdown bk_2">
			<dl id="menu-article">
				...
				<dd>
					<ul>
						<li><a data-href="<?php echo url('article/article_list'); ?>" data-title="资讯管理"
			...
			<dl id="menu-picture">
				...
				<dd>
					<ul>
						<li><a data-href="<?php echo url('picture/picture_list'); ?>" data-title="图片管理"
			...
			<dl id="menu-product">
				...
				<dd>
					<ul>
						<li><a data-href="<?php echo url('product/product_brand'); ?>" data-title="品牌管理"
							href="javascript:void(0)">品牌管理</a></li>
						<li><a data-href="<?php echo url('product/product_category'); ?>" data-title="分类管理"
							href="javascript:void(0)">分类管理</a></li>
						<li><a data-href="<?php echo url('product/product_list'); ?>" data-title="产品管理"
			...
			<dl id="menu-member">
				...
				<dd>
					<ul>
						...
						<li><a data-href="<?php echo url('member/member_del'); ?>" data-title="删除的会员"
							href="javascript:;">删除的会员</a></li>
						<li><a data-href="<?php echo url('member/member_level'); ?>" data-title="等级管理"
							href="javascript:;">等级管理</a></li>
						<li><a data-href="<?php echo url('member/member_scoreoperation'); ?>"
							data-title="积分管理" href="javascript:;">积分管理</a></li>
						<li><a data-href="<?php echo url('member/member_record_browse'); ?>"
							data-title="浏览记录" href="javascript:void(0)">浏览记录</a></li>
						<li><a data-href="<?php echo url('member/member_record_download'); ?>"
							data-title="下载记录" href="javascript:void(0)">下载记录</a></li>
						<li><a data-href="<?php echo url('member/member_record_share'); ?>" data-title="分享记录"
			...
			<dl id="menu-admin">
				...
				<dd>
					<ul>
						<li><a data-href="<?php echo url('admin/admin_role'); ?>" data-title="角色管理"
							href="javascript:void(0)">角色管理</a></li>
						<li><a data-href="<?php echo url('admin/admin_permission'); ?>" data-title="权限管理"
							href="javascript:void(0)">权限管理</a></li>
						<li><a data-href="<?php echo url('admin/admin_list'); ?>" data-title="管理员列表"
			...
			<dl id="menu-tongji">
				...
				<dd>
					<ul>
						<li><a data-href="<?php echo url('charts/charts1'); ?>" data-title="折线图"
							href="javascript:void(0)">折线图</a></li>
						<li><a data-href="<?php echo url('charts/charts2'); ?>" data-title="时间轴折线图"
							href="javascript:void(0)">时间轴折线图</a></li>
						<li><a data-href="<?php echo url('charts/charts3'); ?>" data-title="区域图"
							href="javascript:void(0)">区域图</a></li>
						<li><a data-href="<?php echo url('charts/charts4'); ?>" data-title="柱状图"
							href="javascript:void(0)">柱状图</a></li>
						<li><a data-href="<?php echo url('charts/charts5'); ?>" data-title="饼状图"
							href="javascript:void(0)">饼状图</a></li>
						<li><a data-href="<?php echo url('charts/charts6'); ?>" data-title="3D柱状图"
							href="javascript:void(0)">3D柱状图</a></li>
						<li><a data-href="<?php echo url('charts/charts7'); ?>" data-title="3D饼状图"
			...
			<dl id="menu-system">
				...
				<dd>
					<ul>
						<li><a data-href="<?php echo url('system/system_base'); ?>" data-title="系统设置"
							href="javascript:void(0)">系统设置</a></li>
						<li><a data-href="<?php echo url('system/system_category'); ?>" data-title="栏目管理"
							href="javascript:void(0)">栏目管理</a></li>
						<li><a data-href="<?php echo url('system/system_data'); ?>" data-title="数据字典"
							href="javascript:void(0)">数据字典</a></li>
						<li><a data-href="<?php echo url('system/system_shielding'); ?>" data-title="屏蔽词"
							href="javascript:void(0)">屏蔽词</a></li>
						<li><a data-href="<?php echo url('system/system_log'); ?>" data-title="系统日志"
			...
			<dl id="menu-user">
				...
				<dd>
					<ul>
						<li><a data-href="<?php echo url('user/user_list'); ?>" data-title="用户列表"
