<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:129:"F:\xampp-win32-5.6.3-0-VC11-installerroot\xammp\htdocs\www\www.public.devp\public/../application/backend\view\user\user_list.html";i:1544784807;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
  ...
  <div class="cl pd-5 bg-1 bk-gray mt-20">
    ...
    <a href="javascript:;" onclick="user_add('850','','添加用户','<?php echo url('user/user_add'); ?>')" class="btn btn-primary radius"><i class="icon-plus"></i> 添加用户</a></span>
  ...
  <table class="table table-border table-bordered table-hover table-bg table-sort">
    ...
    <tbody>
      <tr class="text-c">
        ...
        <td><u style="cursor:pointer" class="text-primary" onclick="user_show('850','','张三','<?php echo url('user/user_show'); ?>')">张三</u></td>
        <td>男</td>
        <td>13000000000</td>
